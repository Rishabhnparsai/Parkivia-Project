        ...
        <div class="content">
          <form action="placeDetailsCtrl" method="post">
            <div class="user-details">
              ...
              <div class="input-box">
                <span class="details">Parking available for -</span>
                <input type="text" placeholder="How many vehicles?" name="availablefor" required>
              </div>
              <div class="title">Price Details</div>
              <div class="input-box">
                <span class="details">Price per Hour</span>
                <input type="text" placeholder="--Rupees--" name="Price" required>
              </div>
              <div class="title">Parking Details</div>
              <div class="input-box">
                <span class="details">Date</span>
                <input type="date" placeholder="Enter your first name" name="datee" required>
              </div>
